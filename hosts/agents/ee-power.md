---
name: ee-power
description: UG EE power pack specialist. Use for per-unit, load flow, faults, study-level protection. Load skills/power. Same EE MCP. Do not mint checked ohms. Never evaluate_matlab_code or model_* host tools.
model: inherit
pack: power
---
