# Loop graph (UG EE knowledge corpus archive)

> **Historical knowledge-corpus graph (complete).** Live execution is skills + MATLAB MCP:
> [`../../LOOP_GRAPH.md`](../../LOOP_GRAPH.md). Do not run this graph.
> Scope archive: [`IMPLEMENTATION_PLAN_KNOWLEDGE.md`](IMPLEMENTATION_PLAN_KNOWLEDGE.md).
>
> XOR: do not treat [`../../EXECUTION_GRAPH.md`](../../EXECUTION_GRAPH.md) or
> [`LOOP_GRAPH_D19.md`](LOOP_GRAPH_D19.md) as live.
