# Sources — Rectangular waveguide cutoff, Hertzian dipole intro

- Syllabus union: [`docs/curriculum-map.md`](../../../../docs/curriculum-map.md) (IITR, NITT, AICTE-family, MIT/Berkeley; GATE overlay Electromagnetics / waveguides / antennas intro).
...
- NPTEL (link only): [Electromagnetic Theory, IIT Kharagpur](https://nptel.ac.in/courses/108106073); antennas and microwave courses (link only).
