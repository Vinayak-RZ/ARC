# Sources — Smith chart, single-stub matching

- Syllabus union: [`docs/curriculum-map.md`](../../../../docs/curriculum-map.md) (IITR, NITT, AICTE-family, MIT/Berkeley; GATE overlay Electromagnetics / microwave intro).
...
- NPTEL (link only): microwave engineering / EM theory courses; cite URL only.
